...
services:
  backend:
    ...
    environment:
      ...
      DISABLE_DATA_DELETION: 'false' # Set to true to disable data deletion (GDPR)
      DISABLE_REVEAL_NAMES: 'false' # Set to true to disable the ability to reveal names, even for board owners
